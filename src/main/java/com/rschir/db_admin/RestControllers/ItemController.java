...
import com.rschir.db_admin.DTO.ItemDTO;
import com.rschir.db_admin.Entities.Item;
import com.rschir.db_admin.Services.ItemService;
...
public class ItemController {
    ...
    public ResponseEntity<ItemDTO> getItemById(@PathVariable Integer itemId) {
        ...
        if (itemById != null) {
            ...
            throw new ResponseStatusException(HttpStatus.NOT_FOUND, "Не найдено по id: " + itemId);
        }
    }
